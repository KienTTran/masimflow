...
class IntroduceAQMutantParasiteInfo {
  int location;
  DateTime date;
  double fraction;

  IntroduceAQMutantParasiteInfo({
  ...
  @override
  String toString() {
    return 'IntroduceAQMutantParasiteInfo(location: $location, date: $date, fraction: $fraction)';
  }
}

class IntroduceAQMutantParasites extends Event {
  List<IntroduceAQMutantParasiteInfo> parasiteInfo;

  IntroduceAQMutantParasites({
    required String id,
  ...
  void addEntry() {
    ...
    parasiteInfo.add(IntroduceAQMutantParasiteInfo(location: 0, date: newDate, fraction: 0.01));
  ...
  factory IntroduceAQMutantParasites.fromYaml(Map<dynamic, dynamic> yaml) {
    final String fID = const Uuid().v4();
    final List infoList = yaml['info'] as List;
    final fParasiteInfo = infoList.map((entry) => IntroduceAQMutantParasiteInfo(
  ...
  @override
  IntroduceAQMutantParasitesState createState() => IntroduceAQMutantParasitesState();
}

class IntroduceAQMutantParasitesState extends EventState<IntroduceAQMutantParasites> {
  @override
